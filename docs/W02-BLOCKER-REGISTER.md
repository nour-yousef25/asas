...
| W02-FINANCIAL-FAMILY-RLS-PREREQUISITES | Financial RLS | Critical | OPEN | F01–F10 closes Donor/Donation audit-runtime only; Budget/Expense, nullable-root backfill, mixed dashboard ownership aggregation and production provider remain unproven | any Financial RLS migration or activation | close each remaining family/runtime and aggregation scope independently; retain session_user-only identity |
