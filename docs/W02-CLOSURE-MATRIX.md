...
| RLS Wave 1 — Beneficiary | Broker lifecycle and Beneficiary ownership/API prerequisite | not run | runtime connection authority blocker documented; no policy/migration added | BLOCKED | global Prisma client cannot prove tenant-bound session_user runtime; no fallback allowed |
