...
|---|---|
| W02 | IN PROGRESS |
| Current scope | Beneficiary ownership/API prerequisite complete; Beneficiary RLS Wave 1 next |
...
| Next authorized action | `W02-RLS-WAVE-1-BENEFICIARY` under the Global Closure Directive |
