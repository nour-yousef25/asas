...
|---|---|
| W02 | IN PROGRESS |
| Current scope | Donor/Donation F01–F10 وBudget/Expense BE01–BE10 وcontrol-plane ledger CP01–CP12 وnullable-root clean NR01–NR15 — COMPLETE LIMITED AUDIT RUNTIME؛ dashboard المختلط — OPEN |
...
| Next authorized action | nullable-root upgrade rehearsal من pre-successor fixture، ثم dashboard tenant-bound runtime cutover؛ RLS المالي ما زال محظوراً |
