...
| Next authorized action | إكمال Member/KPI runtime evidence على preservation branch، مع بقاء Financial RLS محظوراً حتى عقد provider وتشغيل DR/HA/scale target-like |
