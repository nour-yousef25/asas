...
|---|---|
| W02 | IN PROGRESS |
| Current scope | Donor/Donation F01–F10 وBudget/Expense BE01–BE10 وcontrol-plane ledger CP01–CP12 — COMPLETE LIMITED AUDIT RUNTIME؛ dashboard المختلط وnullable-root ownership — OPEN |
...
| Next authorized action | ownership decision صريح لـMember وKPI/KPIRecord، ثم successor migration/backfill rehearsal؛ RLS المالي ما زال محظوراً |
