...
// PATCHED (local, uncommitted, out-of-tree invocation only): preserve pnpm's internal
// relative symlinks instead of dereferencing them. Dereferencing breaks resolution of
// packages like @swc/helpers that pnpm places as private siblings inside
// node_modules/.pnpm/<pkg>@<version>/node_modules/ rather than inside the dependent
// package's own directory tree. Relative symlinks remain valid once the whole
// node_modules/.pnpm tree is copied alongside them.
fs.cpSync(
